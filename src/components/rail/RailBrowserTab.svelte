...
<div class="flex h-full min-w-0 flex-col bg-background">
  <div class="flex h-8 min-h-8 items-center gap-0.5 overflow-x-auto border-b border-border bg-sidebar px-1">
  ...
  <form
    class="relative flex h-8 min-h-8 min-w-0 items-center gap-1 border-b border-border bg-sidebar px-1"
    onsubmit={submitUrl}
  >
    <Button
      type="button"
